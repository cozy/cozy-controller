...
var App, conf, config, fs, initAppsFiles, initDir, initFiles, initLogFiles, initNewDir, initTokenFile, oldConfig, path, permission, randomString, removeOldDir;
...
removeOldDir = (function(_this) {
  return function(callback) {
    ...
    return fs.renameSync(path.join(oldDir, "stack.json"), path.join(newDir, "stack.json"));
