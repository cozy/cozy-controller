...
var App, Client, checkStart, conf, config, controller, couchDBClient, couchDBStarted, errors, fs, initAppsFiles, initDir, initFiles, initLogFiles, initNewDir, initTokenFile, oldConfig, patch, permission, randomString, removeOldDir, spawn, start, startStack;
      ...
      if (started) {
        ...
        return fs.readFile(config('file_stack'), 'utf8', function(err, data) {
          if ((data != null) || data === "") {
            ...
            if (err == null) {
              return startStack(data, 'data-system', function(err, port) {
                var clientDS;
                if (err != null) {
                  return callback(err);
                } else {
