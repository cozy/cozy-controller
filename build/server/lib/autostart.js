...
var App, Client, async, checkStart, config, controller, couchDBClient, couchDBStarted, couchdbHost, couchdbPort, dsHost, dsPort, errors, fs, getApps, getManifest, isCorrect, log, path, permission, recoverStackApp, start, startStack;
