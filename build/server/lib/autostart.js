...
var App, Client, checkStart, config, controller, couchDBClient, couchDBStarted, errors, fs, getManifest, isCorrect, log, permission, recoverStackApp, start, startStack;
...
isCorrect = function(app) {
  return (app.git != null) && (app.name != null) && (app.state != null);
};
