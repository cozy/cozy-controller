...
var compareVersions, exec, executeUntilEmpty, onWrongGitUrl, path, request;
      ...
      return request.get(repoUrl, function(err, res, body) {
        ...
        if ((res != null ? res.statusCode : void 0) !== 200) {
          ...
          if ((gitVersion == null) || compareVersions("1.7.10", gitVersion[0]) === -1) {
            commands.push(("git clone " + url + " && ") + ("cd " + app.dir + " && ") + ("git checkout " + branch + " && ") + "git submodule update --init --recursive");
          } else {
