...
var compareVersions, conf, directory, exec, executeUntilEmpty, log, onBadGitUrl, onWrongGitUrl, path, request;
...
module.exports.update = function(app, callback) {
  return directory.changeOwner(app.user, app.dir, function(err) {
    var branch, commands, config;
    if (err) {
      log.error(err);
      return callback(err);
