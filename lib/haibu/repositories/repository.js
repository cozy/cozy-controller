...
//
// ### function buildBrunch (callback)
// #### @callback {function} Continuation to pass control back to when complete.
// Build brunch for the app associated with this repostory instance on this system
//
Repository.prototype.buildBrunch = function (callback) {
  var self = this;
  haibu.common.brunch.build(self.homeDir);
};
